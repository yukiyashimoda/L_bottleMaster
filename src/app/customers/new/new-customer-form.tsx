      ...
      <div className="space-y-2">
        ...
        <div className="space-y-3">
          {bottles.map((bottle, idx) => (
            <div key={idx} className="rounded-lg border border-stone-200 bg-stone-50 p-3 space-y-3">
              <div className="flex items-center gap-2">
                ...
                />
                <button type="button" onClick={() => removeBottle(idx)} className="text-gray-400 hover:text-red-500 shrink-0">
                  <X className="h-4 w-4" />
                </button>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full h-2 rounded-full appearance-none cursor-pointer accent-gray-800 bg-stone-200"
                    style={{
            ...
            <div className="max-h-40 overflow-y-auto border-t border-stone-200">
              {filteredCustomers.length === 0 ? (
                ...
                filteredCustomers.map((c) => (
                  ...
                  >
                    <input type="checkbox" checked={linkedIds.includes(c.id)} onChange={() => toggleLinked(c.id)} className="accent-gray-800" />
