      ...
      <div className="space-y-2">
        ...
        <div className="space-y-3">
          {bottles.map((bottle, idx) => (
            <div key={idx} className="rounded-lg border border-brand-beige bg-brand-beige p-3 space-y-3">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full h-2 rounded-full appearance-none cursor-pointer accent-brand-plum bg-brand-beige"
                    style={{
